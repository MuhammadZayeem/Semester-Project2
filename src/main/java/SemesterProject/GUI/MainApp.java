...
public class MainApp extends Application {
    ...
    private void loadMockInventoryAndSaveToDB() throws Exception {
        ...
        dbManager.addPart(new FrontLaminatedGlass(t, "Civic X FLG", "Civic X", getRandomStock(), 5, 25000));
        dbManager.addPart(new FrontGlass(t, "Civic X FG Low Stock", "Civic X", getRandomStock(), 5, 12000));
    }
